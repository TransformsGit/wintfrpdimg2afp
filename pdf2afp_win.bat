...
echo %submition_tool%\itm_driver.exe -S %itm_ipaddress% -P 6986 -F"-itm_in_files %%i -itm_out_files E:\OutputTransformIMG2AFP\win\output\out_AFP\%%~pi\%%~ni.CPSI.afp" -s8012
%submition_tool%\itm_driver.exe -S %itm_ipaddress% -P 6986 -F"-itm_in_files %%i -itm_out_files E:\OutputTransformIMG2AFP\win\output\out_AFP\%%~pi\%%~ni.CPSI.afp" -s8012 
...
echo ================================================
 ) >>C:\Users\Administrator\Transforms\TestAll_IMG2AFP\Log\win\testCPSI_pdf2afpCPSI_itm-driver.log 2>&1
