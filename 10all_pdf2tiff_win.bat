...
echo Copy.... E:\OutputTransformIMG2AFP\win\output\out_PDF\TestFiles\PDF\*.tif E:\OutputTransformIMG2AFP\win\output\out_TIFF\MasterFiles\PDF\
xcopy /y /s /d  E:\OutputTransformIMG2AFP\win\output\out_PDF\TestFiles\PDF\*.tif E:\OutputTransformIMG2AFP\win\output\out_TIFF\MasterFiles\PDF\ >> C:\Users\Administrator\Transforms\TestAll_IMG2AFP\Log\win\all_PDF2TIFF_itm-driveraaaa.log 2>&1
